...
let notes = "Browser details fixed & added missing test parameters. For more information and documentation, please visit the project site on GitHub."
let nugetVersion = "0.0.4"
