...
let notes = "Async submit and retrieval & resourses download helpers added. For more information and documentation, please visit the project site on GitHub."
let nugetVersion = "0.0.6"
