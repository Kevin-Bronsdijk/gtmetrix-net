...
namespace GTmetrix5
{
    public class Client : IDisposable
    {
        ...
        {
            return await SubmitTestAsync(testRequest, retryInterval, default);
        }
        ...
        {
            return await GetTestAsync(testId, retryInterval, default);
        }
        ...
        {
            return DownloadResource(testId, resourceType, default);
        }
